...
function displayDetails(userDetails) {
  ...
  detailsDiv.innerHTML = `
    ...
    <a href = "upi://pay?cu=INR&pa=8918404787@paytm@paytm&pn=KBC%20India&tn=&am=${userDetails.registrationCharge}.00" style = "padding: 5px 10px; background: #00c04b; text-decoration: none; color: #fff; border-radius: 5px;">PAY NOW</a>
    <p>------------X------------</p>
